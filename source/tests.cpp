...
TEST_CASE("Output", "[Shape]") {
	Sphere sp_1{ glm::vec3{ 0.2f,-0.3,9.5f },2.0f };
	Sphere sp_2{ glm::vec3{ 3.5f,-3.5f,0.0f },-2.0f };

	Box b_1{ {0.0f,1.2,0.01f}, {0.1f,-1.3f,1.0f} };
...
TEST_CASE("intersect_ray_sphere", " [Sphere] ")
{
	...
	Ray{ glm::vec3{ 0.1f,0.3f,3.0f },glm::vec3{ 0.1f,0.3f,3.0f } };
	Ray{};
	//Sphere a{3.0f};
	Sphere b{ glm::vec3{ 0.1f,0.3f,3.0f }, 3.0f };
	Sphere c{ glm::vec3{ 0.2f,0.0f,2.0f } };
	Sphere d{ glm::vec3{ 0.2f,0.0f,-2.0f }, 0.0f };
	Sphere e{ glm::vec3{ 0.2f,0.0f,-2.0f },20.0f };
	Sphere f{ glm::vec3{ 0.2f,0.0f,-2.0f },21.0f };
}